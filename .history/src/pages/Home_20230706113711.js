    ...
    <>
      ...
      <div className={"bg-black p-4 text-white"}>
        <Container className={"mt-1"}>
          ...
          <p className={"mt-2"}>
            Fullstack developer skilled in PHP, Laravel and React.js with more
            than three years of experience. Passionate about working with new
            technologies, solving interesting technical challenges.
          </p>
        </Container>
      </div>
